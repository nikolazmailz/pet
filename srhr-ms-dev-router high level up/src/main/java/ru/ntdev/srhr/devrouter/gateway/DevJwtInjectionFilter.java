...
public class DevJwtInjectionFilter implements GlobalFilter, Ordered {
    ...
    public DevJwtInjectionFilter(DevJwtService jwtService) {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        String requestedUser = exchange.getRequest().getHeaders().getFirst(DEV_USER_HEADER);
        IssuedDevToken token;
        try {
            token = jwtService.issue(requestedUser, clientIp(exchange.getRequest()));
