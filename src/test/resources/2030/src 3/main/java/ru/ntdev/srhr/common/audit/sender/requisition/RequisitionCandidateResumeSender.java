...
@Slf4j
@Service
public class RequisitionCandidateResumeSender implements AuditSender {

    private static final RequisitionRequestType REQUEST_TYPE = RequisitionRequestType.REQUISITION_CANDIDATE_RESUME;
    private static final String NOT_FOUND_CODE = "SRHR_REQUISITION_GET_CANDIDATE_RESUME_NOT_FOUND";
    private static final String FORBIDDEN_CODE = "SRHR_REQUISITION_GET_CANDIDATE_RESUME_FORBIDDEN";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_REQUISITION_GET_CANDIDATE_RESUME_UNEXPECTED_ERROR";
