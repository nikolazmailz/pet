...
@Slf4j
@Service
public class RequisitionCandidateRecommendationSender implements AuditSender {

    private static final RequisitionRequestType REQUEST_TYPE = RequisitionRequestType.REQUISITION_CANDIDATE_RECOMMENDATION;
    private static final String NOT_FOUND_CODE = "SRHR_REQUISITION_POST_CANDIDATE_RECOMMENDATION_NOT_FOUND";
    private static final String FORBIDDEN_CODE = "SRHR_REQUISITION_POST_CANDIDATE_RECOMMENDATION_FORBIDDEN";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_REQUISITION_POST_CANDIDATE_RECOMMENDATION_UNEXPECTED_ERROR";
