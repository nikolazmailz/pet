...
@Slf4j
@Service
public class RequisitionCandidateInfoSender implements AuditSender {

    private static final RequisitionRequestType REQUEST_TYPE = RequisitionRequestType.REQUISITION_CANDIDATE_INFO;
    private static final String NOT_FOUND_CODE = "SRHR_REQUISITION_GET_CANDIDATE_INFO_NOT_FOUND";
    private static final String FORBIDDEN_CODE = "SRHR_REQUISITION_GET_CANDIDATE_INFO_FORBIDDEN";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_REQUISITION_GET_CANDIDATE_INFO_UNEXPECTED_ERROR";
