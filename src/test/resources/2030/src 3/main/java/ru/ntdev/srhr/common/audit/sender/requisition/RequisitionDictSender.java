...
public class RequisitionDictSender implements AuditSender {
    ...
    private static final RequisitionRequestType REQUEST_TYPE = RequisitionRequestType.REQUISITION_DICT;
    private static final String NOT_FOUND_CODE = "SRHR_REQUISITION_NOT_FOUND_GET_DICT";
    private static final String FORBIDDEN_CODE = "SRHR_REQUISITION_FORBIDDEN_GET_DICT";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_REQUISITION_UNEXPECTED_ERROR_GET_DICT";
