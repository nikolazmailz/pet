...
@Slf4j
@Service
public class VacationreqTransferCancelSender implements AuditSender {

    private static final VacationreqRequestType REQUEST_TYPE = VacationreqRequestType.VACATIONREQ_TRANSFER_CANCEL;
    private static final String NOT_FOUND_CODE = "SRHR_VACATIONREQ_REST_NOT_FOUND_TRANSFER_CANCEL";
    private static final String FORBIDDEN_CODE = "SRHR_VACATIONREQ_REST_FORBIDDEN_TRANSFER_CANCEL";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_VACATIONREQ_REST_UNEXPECTED_ERROR_TRANSFER_CANCEL";
