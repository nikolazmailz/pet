...
@Slf4j
@Service
public class RequisitionDelegationsSender implements AuditSender {

    private static final RequisitionRequestType REQUEST_TYPE = RequisitionRequestType.REQUISITION_DELEGATIONS;
    private static final String NOT_FOUND_CODE = "SRHR_REQUISITION_NOT_FOUND_GET_DELEGATIONS";
    private static final String FORBIDDEN_CODE = "SRHR_REQUISITION_FORBIDDEN_GET_DELEGATIONS";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_REQUISITION_UNEXPECTED_ERROR_GET_DELEGATIONS";
