...
@Slf4j
@Service
public class VacationreqRecallHistorySender implements AuditSender {

    private static final VacationreqRequestType REQUEST_TYPE = VacationreqRequestType.VACATIONREQ_RECALL_HISTORY;
    private static final String NOT_FOUND_CODE = "SRHR_VACATIONREQ_REST_NOT_FOUND_RECALL_HISTORY";
    private static final String FORBIDDEN_CODE = "SRHR_VACATIONREQ_REST_FORBIDDEN_RECALL_HISTORY";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_VACATIONREQ_REST_UNEXPECTED_ERROR_RECALL_HISTORY";
