...
@Slf4j
@Service
public class CollectPendingCandidatesSender implements AuditSender {

    private static final RequisitionRequestType REQUEST_TYPE = RequisitionRequestType.COLLECT_PENDING_CANDIDATES;
