...
@Slf4j
@Service
public class YearbonusReportSender implements AuditSender {

    private static final YearbonusRequestType REQUEST_TYPE = YearbonusRequestType.YEARBONUS_REPORT;
    private static final String NOT_FOUND_CODE = "SRHR_YEARBONUS_REST_NOT_FOUND_REPORT";
    private static final String FORBIDDEN_CODE = "SRHR_YEARBONUS_REST_FORBIDDEN_REPORT";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_YEARBONUS_REST_UNEXPECTED_ERROR_REPORT";
