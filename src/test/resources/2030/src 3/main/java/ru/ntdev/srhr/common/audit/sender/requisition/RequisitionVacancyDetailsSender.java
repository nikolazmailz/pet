...
@Slf4j
@Service
public class RequisitionVacancyDetailsSender implements AuditSender {

    private static final RequisitionRequestType REQUEST_TYPE = RequisitionRequestType.REQUISITION_VACANCY_DETAILS;
    private static final String NOT_FOUND_CODE = "SRHR_REQUISITION_GET_VACANCY_DETAILS_NOT_FOUND";
    private static final String FORBIDDEN_CODE = "SRHR_REQUISITION_GET_VACANCY_DETAILS_FORBIDDEN";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_REQUISITION_GET_VACANCY_DETAILS_UNEXPECTED_ERROR";
