...
@Slf4j
@Service
public class UserinfoUserlistSender implements AuditSender {

    private static final UserinfoRequestType REQUEST_TYPE = UserinfoRequestType.USERINFO_USERLIST;
    private static final String NOT_FOUND_CODE = "SRHR_USERINFO_REST_NOT_FOUND_USERLIST";
    private static final String FORBIDDEN_CODE = "SRHR_USERINFO_REST_FORBIDDEN_USERLIST";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_USERINFO_REST_UNEXPECTED_ERROR_USERLIST";
