...
@Slf4j
@Service
public class VacationreqInfotextCancelSender implements AuditSender {

    private static final VacationreqRequestType REQUEST_TYPE = VacationreqRequestType.VACATIONREQ_INFOTEXT_CANCEL;
    private static final String NOT_FOUND_CODE = "SRHR_VACATIONREQ_REST_NOT_FOUND_INFOTEXT_CANCEL";
    private static final String FORBIDDEN_CODE = "SRHR_VACATIONREQ_REST_FORBIDDEN_INFOTEXT_CANCEL";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_VACATIONREQ_REST_UNEXPECTED_ERROR_INFOTEXT_CANCEL";
