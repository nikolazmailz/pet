...
@Slf4j
@Service
public class RequisitionVacancyStatisticsSender implements AuditSender {

    private static final RequisitionRequestType REQUEST_TYPE = RequisitionRequestType.REQUISITION_VACANCY_STATISTICS;
    private static final String NOT_FOUND_CODE = "SRHR_REQUISITION_GET_VACANCY_STATISTICS_NOT_FOUND";
    private static final String FORBIDDEN_CODE = "SRHR_REQUISITION_GET_VACANCY_STATISTICS_FORBIDDEN";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_REQUISITION_GET_VACANCY_STATISTICS_UNEXPECTED_ERROR";
