...
@Slf4j
@Service
public class RequisitionStaffSearchSender implements AuditSender {

    private static final RequisitionRequestType REQUEST_TYPE = RequisitionRequestType.REQUISITION_STAFF_SEARCH;
    private static final String NOT_FOUND_CODE = "SRHR_REQUISITION_GET_STAFF_SEARCH_NOT_FOUND";
    private static final String FORBIDDEN_CODE = "SRHR_REQUISITION_GET_STAFF_SEARCH_FORBIDDEN";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_REQUISITION_GET_STAFF_SEARCH_UNEXPECTED_ERROR";
