...
@Slf4j
@Service
public class RequisitionUserInfoSender implements AuditSender {

    private static final RequisitionRequestType REQUEST_TYPE = RequisitionRequestType.REQUISITION_USER_INFO;
    private static final String NOT_FOUND_CODE = "SRHR_REQUISITION_NOT_FOUND_GET_USER_INFO";
    private static final String FORBIDDEN_CODE = "SRHR_REQUISITION_FORBIDDEN_GET_USER_INFO";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_REQUISITION_UNEXPECTED_ERROR_GET_USER_INFO";
