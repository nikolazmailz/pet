...
@Slf4j
@Service
public class TimesheetGetReportApproximateTimeSender implements AuditSender {

    private static final TimesheetRequestType REQUEST_TYPE = TimesheetRequestType.TIMESHEET_GET_REPORT_APPROXIMATE_TIME;
    private static final String NOT_FOUND_CODE = "SRHR_TIMESHEET_REST_GET_NOT_FOUND_REPORT_APPROXIMATE_TIME";
    private static final String FORBIDDEN_CODE = "SRHR_TIMESHEET_REST_GET_FORBIDDEN_REPORT_APPROXIMATE_TIME";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_TIMESHEET_REST_GET_UNEXPECTED_ERROR_REPORT_APPROXIMATE_TIME";
