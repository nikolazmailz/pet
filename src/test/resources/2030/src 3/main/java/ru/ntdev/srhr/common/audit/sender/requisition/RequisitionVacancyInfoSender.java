...
@Slf4j
@Service
public class RequisitionVacancyInfoSender implements AuditSender {

    private static final RequisitionRequestType REQUEST_TYPE = RequisitionRequestType.REQUISITION_VACANCY_INFO;
    private static final String NOT_FOUND_CODE = "SRHR_REQUISITION_POST_VACANCY_INFO_NOT_FOUND";
    private static final String FORBIDDEN_CODE = "SRHR_REQUISITION_POST_VACANCY_INFO_FORBIDDEN";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_REQUISITION_POST_VACANCY_INFO_UNEXPECTED_ERROR";
