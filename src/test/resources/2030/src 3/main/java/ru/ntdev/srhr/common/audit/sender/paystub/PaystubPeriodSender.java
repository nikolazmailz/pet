...
@Slf4j
@Service
public class PaystubPeriodSender implements AuditSender {

    private static final PaystubRequestType REQUEST_TYPE = PaystubRequestType.PAYSTUB_PERIOD;
    private static final String NOT_FOUND_CODE = "SRHR_PAYSTUB_REST_NOT_FOUND_PERIOD";
    private static final String FORBIDDEN_CODE = "SRHR_PAYSTUB_REST_FORBIDDEN_PERIOD";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_PAYSTUB_REST_UNEXPECTED_ERROR_PERIOD";
