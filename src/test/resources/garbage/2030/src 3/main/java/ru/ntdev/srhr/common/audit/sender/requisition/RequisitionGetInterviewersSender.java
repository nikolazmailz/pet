...
@Slf4j
@Service
public class RequisitionGetInterviewersSender implements AuditSender {

    private static final RequisitionRequestType REQUEST_TYPE = RequisitionRequestType.REQUISITION_GET_INTERVIEWERS;
    private static final String NOT_FOUND_CODE = "SRHR_REQUISITION_GET_GET_INTERVIEWERS_NOT_FOUND";
    private static final String FORBIDDEN_CODE = "SRHR_REQUISITION_GET_GET_INTERVIEWERS_FORBIDDEN";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_REQUISITION_GET_GET_INTERVIEWERS_UNEXPECTED_ERROR";
