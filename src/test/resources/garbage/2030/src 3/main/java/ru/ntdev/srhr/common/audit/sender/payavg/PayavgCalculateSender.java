...
@Slf4j
@Service
public class PayavgCalculateSender implements AuditSender {

    private static final PayavgRequestType REQUEST_TYPE = PayavgRequestType.PAYAVG_CALCULATE;
    private static final String NOT_FOUND_CODE = "SRHR_PAYAVG_REST_NOT_FOUND_CALCULATE";
    private static final String FORBIDDEN_CODE = "SRHR_PAYAVG_REST_FORBIDDEN_CALCULATE";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_PAYAVG_REST_UNEXPECTED_ERROR_CALCULATE";
