...
@Slf4j
@Service
public class YearbonusInfoSender implements AuditSender {

    private static final YearbonusRequestType REQUEST_TYPE = YearbonusRequestType.YEARBONUS_INFO;
    private static final String NOT_FOUND_CODE = "SRHR_YEARBONUS_REST_NOT_FOUND_INFO";
    private static final String FORBIDDEN_CODE = "SRHR_YEARBONUS_REST_FORBIDDEN_INFO";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_YEARBONUS_REST_UNEXPECTED_ERROR_INFO";
