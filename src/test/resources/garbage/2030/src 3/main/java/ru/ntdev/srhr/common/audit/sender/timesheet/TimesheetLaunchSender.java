...
@Slf4j
@Service
public class TimesheetLaunchSender implements AuditSender {

    private static final TimesheetRequestType REQUEST_TYPE = TimesheetRequestType.TIMESHEET_LAUNCH;
    private static final String NOT_FOUND_CODE = "SRHR_TIMESHEET_REST_NOT_FOUND_SIGNED_AGREEMENT";
    private static final String FORBIDDEN_CODE = "SRHR_TIMESHEET_REST_FORBIDDEN_SIGNED_AGREEMENT";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_TIMESHEET_REST_UNEXPECTED_ERROR_SIGNED_AGREEMENT";
