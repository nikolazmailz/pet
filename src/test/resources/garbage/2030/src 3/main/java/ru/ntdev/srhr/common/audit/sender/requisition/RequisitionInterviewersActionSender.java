...
@Slf4j
@Service
public class RequisitionInterviewersActionSender implements AuditSender {

    private static final RequisitionRequestType REQUEST_TYPE = RequisitionRequestType.REQUISITION_INTERVIEWERS_ACTION;
    private static final String NOT_FOUND_CODE = "SRHR_REQUISITION_POST_INTERVIEWERS_ACTION_NOT_FOUND";
    private static final String FORBIDDEN_CODE = "SRHR_REQUISITION_POST_INTERVIEWERS_ACTION_FORBIDDEN";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_REQUISITION_POST_INTERVIEWERS_ACTION_UNEXPECTED_ERROR";
