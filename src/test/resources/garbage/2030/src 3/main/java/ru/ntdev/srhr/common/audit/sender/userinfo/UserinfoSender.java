...
@Slf4j
@Service
public class UserinfoSender implements AuditSender {

    private static final UserinfoRequestType REQUEST_TYPE = UserinfoRequestType.USERINFO;
    private static final String NOT_FOUND_CODE = "SRHR_USERINFO_STAFF_NOT_FOUND_GET_BY_ADLOGIN";
    private static final String FORBIDDEN_CODE = "SRHR_USERINFO_REST_FORBIDDEN_GET_STAFF";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_USERINFO_REST_UNEXPECTED_ERROR";
