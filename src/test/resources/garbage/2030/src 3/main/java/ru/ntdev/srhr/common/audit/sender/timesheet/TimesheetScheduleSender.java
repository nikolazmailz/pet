...
@Slf4j
@Service
public class TimesheetScheduleSender implements AuditSender {

    private static final TimesheetRequestType REQUEST_TYPE = TimesheetRequestType.TIMESHEET_SCHEDULE;
    private static final String NOT_FOUND_CODE = "SRHR_TIMESHEET_REST_NOT_FOUND_TIMESHEET_SCHEDULE";
    private static final String FORBIDDEN_CODE = "SRHR_TIMESHEET_REST_FORBIDDEN_TIMESHEET_SCHEDULE";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_TIMESHEET_REST_UNEXPECTED_ERROR_TIMESHEET_SCHEDULE";
