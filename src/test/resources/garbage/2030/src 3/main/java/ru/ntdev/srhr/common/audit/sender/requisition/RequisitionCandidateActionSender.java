...
@Slf4j
@Service
public class RequisitionCandidateActionSender implements AuditSender {

    private static final RequisitionRequestType REQUEST_TYPE = RequisitionRequestType.REQUISITION_CANDIDATE_ACTION;
    private static final String NOT_FOUND_CODE = "SRHR_REQUISITION_POST_CANDIDATE_ACTION_NOT_FOUND";
    private static final String FORBIDDEN_CODE = "SRHR_REQUISITION_POST_CANDIDATE_ACTION_FORBIDDEN";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_REQUISITION_POST_CANDIDATE_ACTION_UNEXPECTED_ERROR";
