...
@Slf4j
@Service
public class RequisitionVacancyCandidatesSender implements AuditSender {

    private static final RequisitionRequestType REQUEST_TYPE = RequisitionRequestType.REQUISITION_VACANCY_CANDIDATES;
    private static final String NOT_FOUND_CODE = "SRHR_REQUISITION_POST_VACANCY_CANDIDATES_NOT_FOUND";
    private static final String FORBIDDEN_CODE = "SRHR_REQUISITION_POST_VACANCY_CANDIDATES_FORBIDDEN";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_REQUISITION_POST_VACANCY_CANDIDATES_UNEXPECTED_ERROR";
