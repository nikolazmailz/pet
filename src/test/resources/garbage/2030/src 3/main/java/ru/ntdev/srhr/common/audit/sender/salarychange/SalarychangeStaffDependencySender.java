...
@Slf4j
@Service
public class SalarychangeStaffDependencySender implements AuditSender {

    private static final SalarychangeRequestType REQUEST_TYPE = SalarychangeRequestType.SALARYCHANGE_STAFF_DEPENDENCY;
    private static final String NOT_FOUND_CODE = "SRHR_SALARYCHANGE_REST_NOT_FOUND_SALARYCHANGE_STAFF_DEPENDENCY";
    private static final String FORBIDDEN_CODE = "SRHR_SALARYCHANGE_REST_FORBIDDEN_SALARYCHANGE_STAFF_DEPENDENCY";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_SALARYCHANGE_REST_UNEXPECTED_ERROR_SALARYCHANGE_STAFF_DEPENDENCY";
