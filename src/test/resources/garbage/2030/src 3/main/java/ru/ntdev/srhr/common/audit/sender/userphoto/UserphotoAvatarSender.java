...
@Slf4j
@Service
public class UserphotoAvatarSender implements AuditSender {

    private static final UserphotoRequestType REQUEST_TYPE = UserphotoRequestType.USERPHOTO_AVATAR;
    private static final String NOT_FOUND_CODE = "SRHR_USERPHOTO_REST_NOT_FOUND_AVATAR";
    private static final String FORBIDDEN_CODE = "SRHR_USERPHOTO_REST_FORBIDDEN_AVATAR";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_USERPHOTO_REST_UNEXPECTED_ERROR_AVATAR";
