...
@Slf4j
@Service
public class ScheduleHolidayRequestInfoSender implements AuditSender {

    private static final ScheduleHolidayRequestType REQUEST_TYPE = ScheduleHolidayRequestType.SCHEDULE_HOLIDAY_REQUEST_INFO;
    private static final String NOT_FOUND_CODE = "SRHR_SCHEDULE_HOLIDAY_REST_NOT_FOUND_SCHEDULE_HOLIDAY_REQUEST_INFO";
    private static final String FORBIDDEN_CODE = "SRHR_SCHEDULE_HOLIDAY_REST_FORBIDDEN_SCHEDULE_HOLIDAY_REQUEST_INFO";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_SCHEDULE_HOLIDAY_REST_UNEXPECTED_ERROR_SCHEDULE_HOLIDAY_REQUEST_INFO";
