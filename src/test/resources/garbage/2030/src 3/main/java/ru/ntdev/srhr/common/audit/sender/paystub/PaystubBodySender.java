...
@Slf4j
@Service
public class PaystubBodySender implements AuditSender {

    private static final PaystubRequestType REQUEST_TYPE = PaystubRequestType.PAYSTUB_BODY;
    private static final String NOT_FOUND_CODE = "SRHR_PAYSTUB_REST_NOT_FOUND_BODY";
    private static final String FORBIDDEN_CODE = "SRHR_PAYSTUB_REST_FORBIDDEN_BODY";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_PAYSTUB_REST_UNEXPECTED_ERROR_BODY";
