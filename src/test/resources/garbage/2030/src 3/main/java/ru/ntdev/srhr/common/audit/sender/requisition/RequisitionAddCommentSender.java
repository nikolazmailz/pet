...
@Slf4j
@Service
public class RequisitionAddCommentSender implements AuditSender {

    private static final RequisitionRequestType REQUEST_TYPE = RequisitionRequestType.REQUISITION_ADD_COMMENT;
    private static final String NOT_FOUND_CODE = "SRHR_REQUISITION_POST_ADD_COMMENT_NOT_FOUND";
    private static final String FORBIDDEN_CODE = "SRHR_REQUISITION_POST_ADD_COMMENT_FORBIDDEN";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_REQUISITION_POST_ADD_COMMENT_UNEXPECTED_ERROR";
