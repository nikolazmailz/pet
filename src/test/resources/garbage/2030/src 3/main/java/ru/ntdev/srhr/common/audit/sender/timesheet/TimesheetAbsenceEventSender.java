...
@Slf4j
@Service
public class TimesheetAbsenceEventSender implements AuditSender {

    private static final TimesheetRequestType REQUEST_TYPE = TimesheetRequestType.TIMESHEET_ABSENCE_EVENT;
    private static final String NOT_FOUND_CODE = "SRHR_TIMESHEET_REST_NOT_FOUND_EVENT_ABSENCE";
    private static final String FORBIDDEN_CODE = "SRHR_TIMESHEET_REST_FORBIDDEN_EVENT_ABSENCE";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_TIMESHEET_REST_UNEXPECTED_ERROR_EVENT_ABSENCE";
