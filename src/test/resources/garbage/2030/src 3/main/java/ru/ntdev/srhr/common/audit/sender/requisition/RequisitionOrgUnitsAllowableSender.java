...
@Slf4j
@Service
public class RequisitionOrgUnitsAllowableSender implements AuditSender {

    private static final RequisitionRequestType REQUEST_TYPE = RequisitionRequestType.REQUISITION_ORG_UNITS_ALLOWABLE;
    private static final String NOT_FOUND_CODE = "SRHR_REQUISITION_NOT_FOUND_GET_ORG_UNITS_ALLOWABLE";
    private static final String FORBIDDEN_CODE = "SRHR_REQUISITION_FORBIDDEN_GET_ORG_UNITS_ALLOWABLE";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_REQUISITION_UNEXPECTED_ERROR_GET_ORG_UNITS_ALLOWABLE";
