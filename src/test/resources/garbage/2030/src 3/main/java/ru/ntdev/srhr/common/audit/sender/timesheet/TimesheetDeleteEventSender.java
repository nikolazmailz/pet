...
@Slf4j
@Service
public class TimesheetDeleteEventSender implements AuditSender {

    private static final TimesheetRequestType REQUEST_TYPE = TimesheetRequestType.TIMESHEET_DELETE_EVENT;
    private static final String NOT_FOUND_CODE = "SRHR_TIMESHEET_REST_NOT_FOUND_DELETE_TIMESHEET_EVENT";
    private static final String FORBIDDEN_CODE = "SRHR_TIMESHEET_REST_FORBIDDEN_DELETE_TIMESHEET_EVENT";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_TIMESHEET_REST_UNEXPECTED_ERROR_DELETE_TIMESHEET_EVENT";
