...
@Slf4j
@Service
public class TeamCalendarPostEmployeeListSender implements AuditSender {

    private static final TeamCalendarRequestType REQUEST_TYPE = TeamCalendarRequestType.TEAM_CALENDAR_POST_EMPLOYEE_LIST;
    private static final String NOT_FOUND_CODE = "SRHR_TEAM_CALENDAR_REST_NOT_FOUND_TEAM_CALENDAR_POST_EMPLOYEE_LIST";
    private static final String FORBIDDEN_CODE = "SRHR_TEAM_CALENDAR_REST_FORBIDDEN_TEAM_CALENDAR_POST_EMPLOYEE_LIST";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_TEAM_CALENDAR_REST_UNEXPECTED_ERROR_TEAM_CALENDAR_POST_EMPLOYEE_LIST";
