...
@Slf4j
@Service
public class UserinfoTeamSender implements AuditSender {

    private static final UserinfoRequestType REQUEST_TYPE = UserinfoRequestType.USERINFO_TEAM;
    private static final String NOT_FOUND_CODE = "SRHR_USERINFO_REST_NOT_FOUND_TEAM";
    private static final String FORBIDDEN_CODE = "SRHR_USERINFO_REST_FORBIDDEN_TEAM";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_USERINFO_REST_UNEXPECTED_ERROR_TEAM";
