...
@Slf4j
@Service
public class SalarychangeReportAttachmentSender implements AuditSender {

    private static final SalarychangeRequestType REQUEST_TYPE = SalarychangeRequestType.SALARYCHANGE_REPORT_ATTACHMENT;
    private static final String NOT_FOUND_CODE = "SRHR_SALARYCHANGE_REST_NOT_FOUND_SALARYCHANGE_REPORT_ATTACHMENT";
    private static final String FORBIDDEN_CODE = "SRHR_SALARYCHANGE_REST_FORBIDDEN_SALARYCHANGE_REPORT_ATTACHMENT";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_SALARYCHANGE_REST_UNEXPECTED_ERROR_SALARYCHANGE_REPORT_ATTACHMENT";
