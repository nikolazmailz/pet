...
@Slf4j
@Service
public class SalarychangePostStaffDetailSender implements AuditSender {

    private static final SalarychangeRequestType REQUEST_TYPE = SalarychangeRequestType.SALARYCHANGE_POST_STAFF_DETAIL;
    private static final String NOT_FOUND_CODE = "SRHR_SALARYCHANGE_REST_NOT_FOUND_SALARYCHANGE_POST_STAFF_DETAIL";
    private static final String FORBIDDEN_CODE = "SRHR_SALARYCHANGE_REST_FORBIDDEN_SALARYCHANGE_POST_STAFF_DETAIL";
    private static final String UNEXPECTED_ERROR_CODE = "SRHR_SALARYCHANGE_REST_UNEXPECTED_ERROR_SALARYCHANGE_POST_STAFF_DETAIL";
