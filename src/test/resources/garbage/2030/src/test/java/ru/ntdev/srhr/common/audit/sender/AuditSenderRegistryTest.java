...
class AuditSenderRegistryTest {
    ...
    private static final List<Expected> EXPECTED = List.of(
            ...
            new Expected("timesheet_attachment_list", new TimesheetAttachmentListSender(), "SRHR_TIMESHEET_REST_NOT_FOUND_TIMESHEET_ATTACHMENT_LIST", "SRHR_TIMESHEET_REST_FORBIDDEN_TIMESHEET_ATTACHMENT_LIST", "SRHR_TIMESHEET_REST_UNEXPECTED_ERROR_TIMESHEET_ATTACHMENT_LIST"),
