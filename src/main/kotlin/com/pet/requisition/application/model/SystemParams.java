...
public class SystemParams {
    private String correlationId, requestType, sessionId, adLogin, traceId, channel, realm, role, rolesHeader, tabNumber;
    ...
    public String getAdLogin(){return adLogin;} public void setAdLogin(String v){adLogin=v;}
    ...
    public String getRealm(){return realm;} public void setRealm(String v){realm=v;}
    public String getRole(){return role;} public void setRole(String v){role=v;}
    public String getRolesHeader(){return rolesHeader;} public void setRolesHeader(String v){rolesHeader=v;}
    public String getTabNumber(){return tabNumber;} public void setTabNumber(String v){tabNumber=v;}
}
