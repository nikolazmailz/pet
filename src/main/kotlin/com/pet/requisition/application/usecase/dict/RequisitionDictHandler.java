...
public class RequisitionDictHandler implements RequestHandler<Void, Map<String, String>> {
    ...
    public RequisitionDictHandler(RequisitionDictUseCase useCase) {
    ...
    public Map<String, String> handle(PreparedRequest<Void> request) {
        return useCase.execute(request.systemParams());
    }
}
